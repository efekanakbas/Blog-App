...
const createNetworkClient = () => {
    const network = axios.create({
        baseURL: 'https://192.168.1.37:5000/'
    });

    // İstekleri yakalama ve token ekleme
    network.interceptors.request.use(async config => {
        const token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2NWU3NzgwZGI1YWVjYjZhZTEwYTE1NWYiLCJpYXQiOjE3MDk2OTM1OTksImV4cCI6MTcxMDI5ODM5OX0.04e8FuiI6khQ3Iq7sqR5nN1CQ9_12GEhtZQmSnLKKB0";
        if (token) {
